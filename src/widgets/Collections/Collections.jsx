...
const Collection = () => {
  ...
  return (
    <main className="mb-[50px]">
      ...
      {/* Grid-контейнер для карточек с адаптивными размерами */}
      <div className="container mx-auto px-2 py-5 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4">
        <button
          className="group flex justify-center items-center bg-[rgba(255,255,255,0.02)] rounded-lg hover:bg-[rgba(255,255,255,0.04)] transition-all duration-300"
        ...
        {loading ? (
              <div className="flex flex-col gap-5 items-center justify-center w-full h-[310px] bg-[rgba(255,255,255,0.02)] rounded-[14px]">
              <svg
                  aria-hidden="true"
